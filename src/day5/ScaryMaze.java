...
int win = -65261;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("SCREEM.wav"));
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("Joseph's Scary Maze");
		frame.add(this);
